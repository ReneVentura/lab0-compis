...
assignStatement: newVarDeclaration | varDeclaration | declaration ;
ifStatement: LET? IF boolExpression THEN statement (ELSE IF boolExpression THEN LBRACE? statement RBRACE?)* elseStatement? FI* SEMICOLON?;
